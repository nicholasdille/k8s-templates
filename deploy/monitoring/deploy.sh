if ! ${KIND_DEPLOY} && ${MONITORING_FIX_KUBEPROXY_ENABLED} && ./bin/kubectl -n kube-system get configmaps kube-proxy | grep --quiet --invert-match "metricsBindAddress: 0.0.0.0:10249"; then
